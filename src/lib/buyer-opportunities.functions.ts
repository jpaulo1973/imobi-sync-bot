...
function buyerToBuyerLike(b: any): BuyerLike {
  return {
    ...
    categorias: Array.isArray(b.categorias) ? (b.categorias as string[]) : null,
    budget_max_obras: b.budget_max_obras ?? null,
    budget_max_pronto: b.budget_max_pronto ?? null,
    estado_desejado: b.estado_desejado ?? null,
